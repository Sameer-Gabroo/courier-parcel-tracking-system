...
```
cd existing_repo
git remote add origin https://git.thetechmenders.com/internship-projects/courier-parcel-tracking-system.git
git branch -M main
...
* [Set up project integrations](https://git.thetechmenders.com/internship-projects/courier-parcel-tracking-system/-/settings/integrations)
